...
function PersonalBio(){
    return(
        ...
        /* Updated: Added px-4 for mobile and changed lg:flex-row to ensure it stacks on smaller screens */
        <div className="flex flex-col justify-center items-center gap-6 lg:gap-10 lg:flex-row px-4 md:px-0 mb-10">
            {/* Image section */}
            <div className='flex justify-center flex-shrink-0'>
                {/* Fixed: Responsive image width - slightly smaller on mobile, w-64 on desktop */}
            ...
            <div className="flex flex-col justify-center text-[#1B2B41] dark:text-[#f9fafb] text-center lg:text-left">
                {/* Section with bio */}
                {/* Fixed: Scale font-size from 4xl (mobile) to 6xl (desktop) to prevent overflow */}
