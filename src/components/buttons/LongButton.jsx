...
function LongButton({text, link, icon}){
    ...
    return(
        /* Responsive Fixes: 
            - Height: Changed from h-22 to min-h-[70px] md:h-22 for better mobile fit.
            - Text: Changed text-xl to text-lg md:text-xl.
            - Padding: Added responsive horizontal padding.
        */
        <button
